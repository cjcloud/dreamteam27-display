  ...
  theme: {
    extend: {
      colors: {
        ...
        tangerine: 'var(--dt-primary-contrast)', // warm accent (headings/highlights)
        timber: 'var(--dt-accent)',      // secondary light text
        munsell: 'var(--dt-surface-2)',  // accent surface / buttons
